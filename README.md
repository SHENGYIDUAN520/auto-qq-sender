...
通过进一步测试，我们遇到了如下网络环境相关的技术难题：

1. Mirai 安装过程中无法下载依赖包
2. HTTP API 插件无法成功启动和配置
...
1. **测试模式**：
   ```
   powershell -ExecutionPolicy Bypass -File scripts/test_send_en.ps1
   ```
